  ...
  return (
    <div className=" flex flex-col w-screen h-screen bg-amber-50 items-center justify-center gap-20">
      ...
      <div className="flex flex-row gap-20" >
        ...
        <button onClick={() => router.push("./week-8/shopping-list")} className=" bg-amber-700  p-5 text-white rounded-2xl cursor-pointer hover:opacity-40 animate-bounce ">Shopping List</button>
      </div>
    </div>
  );
}